...
ans1 = pipewizard([300 211 400 10],750 ,d1,L1,1);

% Problem 2 ---------------------------------------------------------

guess = [500 100 150 10];
% initial guess for problem two 

ans2 = pipewizard(guess,750,d2,L2,1);
...
disp('-----')
disp('Problem 2: ')
disp(['For an initial guess of Q1 = ' num2str(guess(1)) ...
    ' gal/min, Q2 = ' num2str(guess(2)) ' gal/min, Q3 = ' ...
    num2str(guess(3)) ' gal/min, deltaP = ' num2str(guess(4)) ' psi:'])
