...
INPUT FORMATTING: pipewizard(x_0, Q, d, L, z)
    ...
    x_0: the initial guess for the solution vector to the system of
    equations. It takes the form x_0 = [Q1guess Q2guess Q3guess pressureDropGuess]
    with the flow rates in gal/min and pressure drop in psi
...
%%% Problem 1
ans1 = pipewizard([10 -221110 10 10], 750 , d1, L1, 1);
...
% MaxIterations and MaxFunctionCount values, while keeping track of
% iterations. Each loop iteration should be about 80 fsolve iterations, so
% the cap is >15 loop iterations or ~1200 fsolve iterations.
